...
if (!$conn) {
    ...
    if (isset($_POST['cap_type'])) {
        $selected_option = $_POST['cap_type']; 
    
        if ($selected_option == 'gray') {
            if (isset($_POST['values_gray_cap'])) {
                $selected_values = $_POST['values_gray_cap']; 

            }
        }
         if ($selected_option == 'red') {
            if (isset($_POST['values_red_cap'])) {
                $selected_values = $_POST['values_red_cap']; 

            }
        }
            if ($selected_option == 'pink') {
                if (isset($_POST['values_pink_cap'])) {
                    $selected_values = $_POST['values_pink_cap']; 
        ...
        if ($selected_option == 'green') {
            if (isset($_POST['values_green_cap'])) {
                $selected_values = $_POST['values_green_cap']; 
